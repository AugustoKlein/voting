...
class PautaControllerTest {
    ...
    class Create {
        ...
        public void createSuccess() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/pauta")
                    ...
                    .andExpect(header().string("Location", "/api/v1/pauta/1"));
        }
    ...
    class Vote {
        ...
        public void voteSuccess() throws Exception {
            ...
            mockMvc.perform(put("/api/v1/pauta/{id}/vote", 1)
                            .contentType(MediaType.APPLICATION_JSON)
    ...
    class OpenSession {
        ...
        public void openSuccess() throws Exception {
            ...
            mockMvc.perform(put("/api/v1/pauta/{id}/open-session", 1)
                            .contentType(MediaType.APPLICATION_JSON)
    ...
    class CloseSession {
        ...
        public void closeSuccess() throws Exception {
            ...
            mockMvc.perform(put("/api/v1/pauta/{id}/close-session", 1)
                            .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(status().isOk());
        }
    ...
    class Find {
        ...
        public void findSuccess() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/pauta/{id}", 1)
                            .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(status().isOk());
        }
